...
# ------------------------------------------------------------------- #
    ...
    def l1_perio(self, name,
        ...
        if plot_output:
            ...
            self.plot_clean(N_markers, name,
                            annotations = 'periods',
                            save = True,
                            **kwargs)            
        if verbose >=1:
        ...
        if plot_output:
            start_time = time.time()            
            self.plot_with_list(N_markers, name,
...
# ------------------------------------------------------------------- #
    ...
    def plot_with_list(self,number_highlighted_peaks_in, name,
                      significance_values='log10faps',
                      title = 'default',
        ...
        if save:
            ...
            plt.savefig(name, format='pdf', rasterized = True)

    
        
    def plot_clean(self,number_highlighted_peaks_in, name,
                   annotations='periods',
                   marker_color = (0.85,0.325,0.098),
                   title = 'default',
                   save = False,
